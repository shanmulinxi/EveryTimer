 ...
 * @param {*} option
 */
var customAjax = function (option, loading = false) {
...
var customLoading = text => {
  g_Loading = this.app.$loading({
    lock: true,
    text: text || 'LOADING',
